...
class HomeHalalTabIPadCell: HomeBaseCell {
    ...
    override func awakeFromNib() {
        ...
        HomeHalalTabIPadSubCell.register(collectionView: collectionView)
...
extension HomeHalalTabIPadCell: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: HomeHalalTabIPadSubCell.nibName(), for: indexPath) as! HomeHalalTabIPadSubCell
...
//            }
//        (cell as! HomeHalalTabIPadSubCell).setData()
    }
