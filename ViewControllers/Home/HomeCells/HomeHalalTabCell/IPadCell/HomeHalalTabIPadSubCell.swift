...
//  zabihah
//
//  Created by Shakeel Ahmed on 06/10/2024.
//
...
class HomeHalalTabIPadSubCell: UICollectionViewCell {
...
extension HomeHalalTabIPadSubCell: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
